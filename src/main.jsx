...
function DriveAdaptiveMedia({url}){
  ...
  return <img className="media-fit-image" src={driveThumb(url)} onError={()=>setFallback(true)} alt="Prévia do material"/>;
}
function Media({url}){ 
