...
function DashboardCargaDetail({options,tasks,selected,setSelected,statusById}){
  ...
  const rows=options.map(item=>{
    ...
    return {...item,tasks:itemTasks,edit,alter,total};
